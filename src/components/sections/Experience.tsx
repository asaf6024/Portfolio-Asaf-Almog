          ...
          <div className="relative">
            ...
            {experiences.map((exp, index) => (
              ...
              >
                {/* Timeline dot */}
                <div
                  className={`absolute left-0 md:left-1/2 top-0 w-4 h-4 rounded-full bg-primary border-4 border-background shadow-glow ${
                    index % 2 === 0
                      ? "md:-translate-x-1/2"
                      : "md:-translate-x-1/2"
                  }`}
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    {exp.companyUrl ? (
                      <a
                        ...
                        className="text-muted-foreground hover:text-primary transition-colors inline-flex items-center gap-1 group italic"
                      >
                        {exp.company}
